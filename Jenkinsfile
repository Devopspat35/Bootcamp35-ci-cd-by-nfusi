pipeline {
    ...
    stages {
        ...
        stage ('5. Email Notification') {
            steps {
               mail bcc: 'patpaddy38@gmail.com', body: '''Terraform deployment is completed.
               Let me know if these changes look okay.
               Thanks,
               Think-with-Tech,
              +1 (220) 219-9866''', cc: 'patpaddy38@gmail.com', from: '', replyTo: '', subject: 'Terraform Infra deployment completed!!!', to: 'patpaddy38@gmail.com'
